...
class Company(Base, AuditMixin, PrimaryKeyMixin, ArrayColumnMixin, DimensionMixin, CreateUpdateDateMixin):
    ...
    def __init__(self, **kwargs):
        """
        Construtor para inicializar a instância.

        Inicializa o atributo de instância `addresses` como uma lista vazia
        e depois delega o resto da inicialização para o SQLAlchemy.
        """

        # Declara o atributo de instância e o seu tipo
        self.addresses: list['Address'] = []

        # Chama o construtor da classe pai para que o SQLAlchemy possa popular os
        # atributos mapeados (company, companyName, etc.)
