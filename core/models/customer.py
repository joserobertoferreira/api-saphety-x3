...
from core.config.settings import DATABASE, DB_COLLATION, DEFAULT_LEGACY_DATE, DEFAULT_LEGACY_DATETIME
...
class Customer(
    ...
    # Específicos Saphety
    saphetyType: Mapped[int] = mapped_column('YSAPHTYP_0', TINYINT, default=text('((1))'))
    generatePDF: Mapped[int] = mapped_column('YSAPHPDF_0', TINYINT, default=text('((1))'))
